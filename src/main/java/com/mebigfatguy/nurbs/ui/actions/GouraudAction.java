...
public class GouraudAction implements ActionListener {

    private static final GouraudAction GOURAUD_ACTION = new GouraudAction();

    private GouraudAction() {
    }

    public static GouraudAction get() {
        return GOURAUD_ACTION;
    }
